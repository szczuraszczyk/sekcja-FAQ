  ...
  return (
    <>
...

      {
        data.map(
          (element) => (
            <Item key={element.id} question = {element.question} answer = {element.answer}/>
          )
        )
      }

      {/* <ul>
        <li> <a onClick={handleClick}>pytanie 1</a> <br />
          <p>hhh</p></li>
        <li> <a onClick={handleClick}>pytanie 2</a> <br />
          <p>hhh</p></li>
        <li> <a onClick={handleClick}>pytanie 3</a> <br />
          <p>hhh</p></li>
        <li> <a onClick={handleClick}>pytanie 4</a> <br />
          <p>hhh</p></li>
      </ul> */}
    </>
  )
